...
import { AcademicCapIcon, BeakerIcon, DocumentPlusIcon, Squares2X2Icon } from "@heroicons/react/24/outline";
            ...
            <Link
              ...
              className={`p-3 rounded-2xl transition-all group relative ${
                isActive
                  ...
                  : "text-opacity-50 hover:bg-primary/10 hover:text-primary"
              }`}
            >
